...
SECRET_KEY = 'django-insecure-&ovan98%=49p_qctjli$3!$7^#8hhccx43lbb(le=vyn=oe(1u'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['avborovets.ru', 'www.avborovets.ru']
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        # 'rest_framework.authentication.BasicAuthentication', ## session
